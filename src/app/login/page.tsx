            ...
            <div className="bg-slate-50 h-[45vh] w-[30vw] border gap-4 rounded-xl">
                <div className='flex flex-col justify-start w-[100%]'>
                    ...
                    <div className='mx-7 my-2'>
                        <label className=' text-custom-green cursor-pointer'>Forgot password?</label>
                    </div>
                    ...
                    <div className='flex justify-center mt-6 w-[90%]'>
                        <label>Don't have an account? <span className='text-custom-green cursor-pointer'>Signup</span></label>
                    </div>
                </div>
            </div>
        </div>
